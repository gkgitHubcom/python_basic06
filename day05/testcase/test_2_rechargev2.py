...
from day05.common.myConf import MyConf
from day05.common.my_path import conf_dir
...
class TestRecharge:
    ...
    def test_recharge(self,case):
        ...
        #从响应结果中提取leave_amount的值,并更新全局变量中的leave_amount的值
